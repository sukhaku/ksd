        ...
        <div class="panel panel-default">
          <div class="panel-heading"> Tambah Menu Ksd</div>
            <div class="panel-body">
              <form role="form" action="<?php echo base_url('dashboardAdmin/proses_tambah_menu');?>" method="post">
                <div class="form-group">
                  <label>Nama Menu</label>
                  <input class="form-control" name='nama_menu' style="width:300px;" placeholder="Isikan nama menu" required>
                </div>
