        ...
        <div class="panel panel-default">
          <div class="panel-heading"> Tambah User Ksd</div>
            <div class="panel-body">
              <form role="form" action="<?php echo base_url('dashboardAdmin/proses_tambah_user');?>" method="post">
                <div class="form-group">
                  <label>Username</label>
                  <input class="form-control" name='username' style="width:300px;" placeholder="Isikan username" required>
                </div>

                <div class="form-group">
                  <label>Password</label>
                  <input class="form-control" placeholder="Isikan password"  name='password' style="width:200px;" type='text' required>
                </div>
                <div class="form-group">
                  <label>Nama</label>
                  <input class="form-control" placeholder="Isikan nama"  name='nama' style="width:400px;" type='text' required>
                </div>
